...
type Props = {
  ...
  minVoteRequired?: string | number
  totalVotes?: number
  minTotalVotesRequired?: number
  showBg?: boolean
}
type GenericProps = {
        ...
        <div className="w-full">
          ...
          {!hasMinimumTotal ? (
            <p className="font-bold mb-0 text-fgd-1">
              {`${minTotalVotesRequired?.toLocaleString(undefined, {
                maximumFractionDigits: 0,
              })} total votes needed before considering this proposal valid.`}
            </p>
          ) : (
            <>
